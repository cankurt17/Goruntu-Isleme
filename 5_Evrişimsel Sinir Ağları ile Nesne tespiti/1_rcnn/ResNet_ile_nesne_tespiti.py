...
from image_piramit import image_pyramid
from maksimum_olmayan_bastırma import non_max_suppression

# ilklendirme parametreleri
WIDTH = 600
HEIGHT = 600
PYR_SCALE = 1.5  # piramidin ölçütü
WIN_STEP = 16 # kayan pencerenin piksel mesafesi
ROI_SIZE = (200,150) 
INPUT_SIZE = (224, 224) # resnet cnn boyutu 224,244 olmak zorundadır
