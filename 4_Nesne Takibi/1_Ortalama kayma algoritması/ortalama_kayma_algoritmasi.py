...
# epsilon = değişiklik
term_crit = (cv2.TERM_CRITERIA_EPS | cv2.TERM_CRITERIA_COUNT,5,1) # 5 yineleme veya 1 tane epsilon
...
while True:
    ...
    if ret:
        ...
        # Belirli bir görüntünün piksellerinin histogam dağılımındaki piksellere uyumuna bakar
